...
def train_zest_style():
    opt = Options(img_dim=3072, txt_dim=13217, proto_count=30, txt_to_img_hidden1=4096,
    ...
    net = Attention(dimensions=3072, text_dim=13217).to(device)
...
#     optimizer = torch.optim.Adam(net.parameters(), lr=0.0005, betas=(0.5, 0.9), weight_decay=0.0001)
    ...
    for epoch in range(epochs):
        ...
        with tqdm(train_loader, unit='batch') as tepoch:
            for img_feat, orig_lab, _ in tepoch:
